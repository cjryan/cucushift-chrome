function txtswap(){
  ...
  var scenario_replace = document.getElementById("accordion").innerHTML.replace(/Scenario(?: Outline)?: ([^#]+)/g,'</pre></div><h3>$1</h3><div><pre>$0');
  //var scenario_replace = document.getElementById("accordion").innerHTML.replace(/Scenario: ([^#]+)/g,'</pre></div><h3>$1</h3><div><pre>Scenario: $1');
